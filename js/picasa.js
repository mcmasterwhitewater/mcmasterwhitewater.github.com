(function($) {  
  $.picasa = {
    albums: function(user, callback) {
	  var url = "http://picasaweb.google.com/data/feed/api/user/:user_id?alt=json&kind=album&hl=en_US&access=visible&fields=entry(id,gphoto:numphotos,media:group(media:content,media:description,media:keywords,media:title))&callback=?";
